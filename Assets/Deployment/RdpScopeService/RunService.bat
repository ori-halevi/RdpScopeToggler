...
sc stop RdpScopeService

sc delete RdpScopeService

sc create RdpScopeService binPath= "\"%~dp0RdpScopeService.exe\"" start= auto
sc start RdpScopeService
